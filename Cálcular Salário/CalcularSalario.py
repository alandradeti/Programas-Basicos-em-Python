...
# Cálculo e declaração da variável "salarioBruto", que representa o salário bruto.
salarioBruto = horasTrabalhadas*valorHoras

# Cálculo e declaração da variável "totalDesconto", que representa o total de desconto.
totalDesconto = (percentualDesconto/100)*salarioBruto

# Cálculo e declaração da variável "salarioLiquido", que representa o salário líquido.
